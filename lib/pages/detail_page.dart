...
class _PostViewState extends State<PostView> {
  ...
  Future refresh() async {
    ...
    if (postsList.isEmpty) {
      ...
      postsList = await Network.GET(
          Network.API_SEARCH_LIST,
          Network.paramsSearch(
              page: page,
              topic: widget.search!.isNotEmpty
                  ? widget.search!
      ...
      postsList.addAll(await Network.GET(
          Network.API_SEARCH_LIST,
          Network.paramsSearch(
              page: page,
              topic: widget.search!.isNotEmpty
                ...
                Column(
                  ...
                  children: [
                    ...
                    ListTile(
                      ...
                      subtitle: Text(
                        '${widget.post!.user.totalPhotos} followers',
                        style:
              ...
              Flexible(
                ...
                child: ClipRRect(
                  ...
                  child: CachedNetworkImage(
                    ...
                    placeholder: (context, url) => AspectRatio(
                        aspectRatio:
                            postsList[index].width / postsList[index].height,
                        child: Container(
      ...
      onTap: () {
        Navigator.of(context).push(MaterialPageRoute(
            builder: (BuildContext context) =>
                PostView(post: postsList[index], search: widget.search)));
      },
    );
  }
}
