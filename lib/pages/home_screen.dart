...
class _HomePageState extends State<HomeScreen>
  ...
  void initState() {
    ...
    _scrollController.addListener(() {
      ...
      if (kDebugMode) {
        print(
            'Position: ${_scrollController.position.userScrollDirection}    BOOL: $showFAB');
      }
    });
  }
          ...
          body: IndexedStack(
            ...
            children: [
              TabBarView(controller: _tabController, children: <Widget>[
                Scrollbar(
                  child: Post(pageIndex: _currentPageIndex, tabIndex: 0),
                ),
                Scrollbar(
                  child: Post(pageIndex: _currentPageIndex, tabIndex: 1),
                ),
                Scrollbar(
                  child: Post(pageIndex: _currentPageIndex, tabIndex: 2),
                ),
                Scrollbar(
                  child: Post(pageIndex: _currentPageIndex, tabIndex: 3),
                ),
                Scrollbar(
                  child: Post(pageIndex: _currentPageIndex, tabIndex: 4),
                ),
              ]),
              const Search(),
              _currentPageIndex == 2
                  ? Messages(pageIndex: _currentPageIndex)
                  : const SizedBox(),
              const AccountPage(),
            ],
          ),
